...
public class UserServiceController {
    ...
    {
        return new ResponseEntity<>(userRepository.findAll().stream().map(o -> new UserDTO(o.getId(), o.getUsername(),o.getEmail(),o.getPassword())).collect(Collectors.toList()), HttpStatus.OK);
    }
